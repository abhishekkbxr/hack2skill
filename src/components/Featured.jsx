                ...
                <div className="flex flex-col-reverse md:flex-row items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pr-12 md:pr-8 flex flex-col items-start text-left">
                        ...
                        <div className="flex justify-start">
                            <p className="group inline-flex items-center lg:w-80 py-4 rounded-4xl bg-[#262626] px-12 sm:px-16 font-bold text-white focus:outline-none  hover:border-2 hover:border-white hover:shadow-[0px_10px_10px_rgba(0,0,0,0.5)] hover:translate-y-1 text-lg transition-all duration-300">
                                Lorem Ipsum
